...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnCollectInfo, btnCall, btnSMS, btnCapture;  // Thêm btnCapture
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCapture = findViewById(R.id.btnCapture);  // Ánh xạ nút Capture

...
public class AssignHomeworkActivity extends AppCompatActivity {
    ...
    private HomeworkDBHelper homeworkDBHelper = new HomeworkDBHelper(this);
    ...
    private ActivityResultLauncher<String> filePickerLauncher = registerForActivityResult(
            ...
            uri -> {
                if (uri != null) {
                    ...
                    if (file != null) {
                        copiedFile = file;
                        Log.i(TAG, copiedFile.getAbsolutePath());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String class_name_received = getIntent().getStringExtra("class_name");
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            homeworkDBHelper.insertHomework(title, class_name_received, copiedFile.getAbsolutePath());
